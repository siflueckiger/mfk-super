...
class kamera:
    ...
    def waitButton(self):
        ...
        self.filename = datetime.datetime.now().strftime("%Y-%m-%d_%H%M%S_mfk-super") 

    def take(self, camera):
        camera.capture(rawCapture, format="bgr")
        image = rawCapture.array 
        cv2.imwrite("/home/pi/Desktop/mfk-super/super-camera/mfk-share/" + self.filename + ".png", image)
